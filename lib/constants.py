    ...
    "system0":
        {
            ...
            "tesla_power":                  f"N/{systemId0}/grid/42/Ac/Power",
            "tesla_l1_current":             f"N/{systemId0}/grid/42/Ac/L1/Current",
            "tesla_l2_current":             f"N/{systemId0}/grid/42/Ac/L2/Current",
            "tesla_l3_current":             f"N/{systemId0}/grid/42/Ac/L3/Current",
